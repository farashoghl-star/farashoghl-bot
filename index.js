...
function scheduleFollowUps(ctx, userId) {
  const followUps = [
    { delay: 5 * 60 * 1000, text: "💫 تبریک قهرمان! امروز یه قدم بزرگ برای رشد و شناخت خودت برداشتی...\n👇 تست استعدادیابی شغلی:\nhttps://farashoghl.ir/product/job-test/" },
    { delay: 24 * 60 * 60 * 1000, text: "🎓 آموزش رایگان: کشف رسالت زندگی و مسیر شغلی 👇\nhttps://farashoghl.ir/product/kashfe-resalat/" },
    { delay: 48 * 60 * 60 * 1000, text: "🔍 تست استعدادیابی شغلی رو انجام بده و نتیجه‌اش رو برام بفرست تا تحلیلش رو بگم 👇\nhttps://farashoghl.ir/product/job-test/" },
    { delay: 72 * 60 * 60 * 1000, text: "🌟 یه نفر مثل تو از همین تست شروع کرد… الان مدرس و کارآفرینه!\nمشاهده کارگاه:\nhttps://farashoghl.ir/product/kashfe-resalat/" },
    { delay: 96 * 60 * 60 * 1000, text: "🚀 سلام قهرمان مسیرت!\nفقط تا ۴۸ ساعت برای تخفیف ۵۰٪ کارگاه فرصت داری 👇\nواتساپ: 09357820120" }
  ];
